...
def create_regular_locations(world: DoorSalesmanWorld) -> None:
    ...
    bottom_left_chest = DoorSalesmanLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, DoorSalesmanLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, DoorSalesmanLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, DoorSalesmanLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, DoorSalesmanLocation)
    else:
        overworld.add_locations(top_middle_room_locations, DoorSalesmanLocation)
...
def create_events(world: DoorSalesmanWorld) -> None:
    ...
    button_in_top_left_room = DoorSalesmanLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    final_boss_room.add_event(
        "Final Boss Defeated", "Victory", location_type=DoorSalesmanLocation, item_type=items.APQuestItem
    )
